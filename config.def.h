...
static const char *fonts[]          = { "hack:size=20", "JoyPixels:pixelsize=20" };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-hp", "(bat ~/.config/.dmenu_hp)" , NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *layoutmenu_cmd = "layoutmenu.sh";
static const char *browser[]  = { "firefox", NULL };
static const char *browser2[]  = { "icecat", NULL };
static const char *files[]  = { "thunar", NULL };
static const char *dmenuunicode[]  = { "/usr/local/bin/dmenuunicode", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,            	XK_Return, 		spawn,          {.v = files } },
